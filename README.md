...
当前版本为 `0.1.3`，处于功能开发阶段。中文是主要界面语言，英文保留基础
本地化。

## 0.1.3 更新

- 统一任务记录模型：PDF 翻译按文献独立记录，批量元数据、标题翻译、AI 笔记和文献综述按操作聚合记录。
- 仪表盘增加概览、任务记录、提示词管理和高级设置的统一视觉样式，任务卡片支持展开查看详情。
- 美化插件设置页、配置档编辑器和 Zotero 右侧 AI 笔记预览，统一白色内容面板、状态色和操作控件。
- 增强 AI 笔记预览的 HTML 清理、辅助信息和高度调整体验。
- 完成 Zotero 10 测试环境回归，19 项自动化测试通过。
...
选择 PDF 附件时，预览区会自动使用它的父文献条目。右键菜单生成笔记完成后，预览区
会随 Zotero 条目变化自动更新。
