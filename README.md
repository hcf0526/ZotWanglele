...
当前版本为 `0.1.6`，处于功能开发阶段。中文是主要界面语言，英文保留基础
本地化。

## 0.1.6 更新

- 设置页面、配置编辑器、元数据窗口、操作确认框与插件进度提示统一采用仪表盘的暖色纸感主题，共享色彩、字体和控件状态。
...
- 插件设置页面按供应商分组展示模型配置，模型项仅呈现模型名称，上移、下移调整同组顺序。旧配置沿用原服务商名称，空供应商归入“未填写供应商”。
