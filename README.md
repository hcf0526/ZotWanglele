...
当前版本为 `0.1.4`，处于功能开发阶段。中文是主要界面语言，英文保留基础
本地化。
...
- 条目右键菜单提供“更新文献信息”，按 DOI 查询 Crossref REST API。
...
- 提示词管理统一管理内置 AI 功能的系统提示词和用户提示词；内置功能名称与说明固定，右侧以文本形式展示，提示词支持编辑与恢复。
- 提示词管理也支持新增、编辑、删除自定义模板。
...
2. 打开条目右键菜单，选择“ZotWanglele → 更新文献信息”。
