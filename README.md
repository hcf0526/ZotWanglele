...
当前版本为 `0.1.1`，处于功能开发阶段。中文是主要界面语言，英文保留基础
本地化。

## 0.1.1 更新

- 新增 Zotero 右侧 AI 笔记预览，可查看、生成和打开论文精读及快速摘要笔记。
- 统一提示词管理，内置功能名称与说明固定，系统提示词和用户提示词支持编辑与恢复。
- 更新 Wings & Spark 图标资源，并为工具栏和条目面板提供对应尺寸。
